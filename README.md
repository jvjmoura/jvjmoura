...
class JVMoura:
    def __init__(self):
        self.cargo        = "Juiz de Direito (TJPA)"
        self.atuacao      = "Presidência → Tecnologia da Informação"
        self.doutorado    = "Ciência da Computação @ UFPE"
        self.pos          = "MBA em Ciência de Dados e IA @ IDP/DF"
        self.linguagem    = "Python 🐍"
        self.foco         = ["Data Science", "Machine Learning",
                             "IA aplicada à Justiça", "Automação"]

    def missao(self):
        return "Unir Direito e Tecnologia para um Judiciário mais eficiente."
```

- ⚖️ **Juiz de Direito do TJPA**, atuando junto à **Presidência na área de Tecnologia da Informação**.
- 🎓 **Doutorando em Ciência da Computação** pela **UFPE**.
- 📊 **MBA em Ciência de Dados e Inteligência Artificial** pelo **IDP/DF**.
- 🤖 Interesses: **Data Science, Machine Learning, IA aplicada à Justiça e automação de processos**.
- 💬 Pergunte-me sobre **Python, dados, IA e tecnologia no Judiciário**.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/jvjmoura/jvjmoura/output/snake.svg" alt="snake animation" />
</p>
...
> 💡 *Dica: fixe (pin) seus melhores repositórios no perfil para que apareçam aqui em destaque.*
...
<p align="center">
  <a href="https://www.linkedin.com/in/jvjmoura" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:joao.moura@tjpa.jus.br">
    <img src="https://img.shields.io/badge/E--mail_Institucional-004B8D?style=for-the-badge&logo=maildotru&logoColor=white" />
  </a>
  <a href="mailto:jvjmoura@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="https://www.instagram.com/jvjmoura/" target="_blank">
    <img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white" />
  </a>
</p>

<p align="center">
  📧 <b>Institucional:</b> joao.moura@tjpa.jus.br &nbsp;|&nbsp; <b>Pessoal:</b> jvjmoura@gmail.com
</p>
...
<p align="center">
  <i>"Código é lei — e a lei pode ser melhor com código." ⚖️🐍</i>
</p>
